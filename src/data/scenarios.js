export const SCENARIOS = {
  1: {
    ...
    nodes: [
      ...
      { id: 'elec-1', type: 'electrode', position: { x: 300, y: 150 }, data: { label: 'Pt Electrode', role: 'Electrode Contact', material: 'Platinum', area: 1000, impedance: 2.1, status: 'error' } },
      { id: 'mat-1', type: 'material', position: { x: 300, y: 350 }, data: { label: 'PEDOT:PSS', cil: 15, iso: true } },
      { id: 'elec-2', type: 'electrode', position: { x: 300, y: 550 }, data: { label: 'Reference Electrode', role: 'Reference' } },
  ...
  2: {
    ...
    nodes: [
      ...
      { id: 'elec-6', type: 'electrode', position: { x: 300, y: 150 }, data: { label: 'Ag/AgCl Electrode x2', role: 'Surface Electrode', status: 'valid' } },
  ...
  3: {
    ...
    nodes: [
      ...
      { id: 'elec-11', type: 'electrode', position: { x: 300, y: 150 }, data: { label: 'Antibody Electrode Array', role: 'Sensing Array', area: 500, status: 'error' } },
      { id: 'elec-12', type: 'electrode', position: { x: 300, y: 350 }, data: { label: 'Counter Electrode', role: 'Counter' } },
      { id: 'elec-13', type: 'electrode', position: { x: 300, y: 550 }, data: { label: 'Reference (Ag/AgCl)', role: 'Reference' } },
  ...
  4: {
    ...
    nodes: [
      ...
      { id: 'elec-17', type: 'electrode', position: { x: 300, y: 150 }, data: { label: 'Pt-Ir Electrode Array', role: 'Stimulation', material: 'Platinum-Iridium', area: 5000, status: 'error' } },
      { id: 'mat-2', type: 'material', position: { x: 300, y: 350 }, data: { label: 'Platinum-Iridium', cil: 3.5, iso: true } },
      { id: 'elec-18', type: 'neuromodulation', position: { x: 550, y: 150 }, data: { label: 'Stimulator (Pulse Gen)', role: 'Pulse Generator', current: '5 mA', pulseWidth: '1 ms' } },
  ...
  5: {
    ...
    nodes: [
      ...
      { id: 'elec-21', type: 'microfluidics', position: { x: 300, y: 150 }, data: { label: 'Micro-valve', role: 'Fluidics', flowRate: 50, status: 'valid' } },
      { id: 'mat-3', type: 'material', position: { x: 300, y: 350 }, data: { label: 'Parylene-C', iso: true, chronic: true } },
      { id: 'bio-6', type: 'microfluidics', position: { x: 300, y: -50 }, data: { label: 'Drug Reservoir', role: 'Fluidics', volume: '2 mL' } },
